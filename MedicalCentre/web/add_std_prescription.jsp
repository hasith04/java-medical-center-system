                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="20%" align="center">
                                        <img src="<%= request.getContextPath() %>/RetrieveImage?regNo=<%= request.getParameter("reg_id") %>" width="150" height="150" alt="Image not found"/>
                                    </td>
...
<script type="text/javascript">
	...
	//alert(gen_adv_id);
		...
		else
		{
			...
			var oe_name = $(this).val();
                       ...
                       // alert(t);
                        $.ajax({
                           type: "POST",
                           url: "<%= request.getContextPath() %>/GetOEValue",
                           data: { oename: oe_name },
                           dataType: "json",
        ...
        $('#medicine_type').change(function(){
            ...
            $.ajax({
               type: "POST",
               url: "<%= request.getContextPath() %>/GetMedInfo",
    ...
    //alert(gen_advstr);
               ...
               $.post("<%= request.getContextPath() %>/SubmitStdPrescription",
